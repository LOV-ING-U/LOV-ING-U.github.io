...
+ 이전 게시글 중에 Page interface / PageRequest class / Pageable interface의 구현을 살펴보고 상속 관계를 정리해본 게시글이 있는데(![링크 클릭하여 이동](https://lov-ing-u.github.io/snuxi/snuxi_3/)), 이렇게 최적화에 사용이 되는구나 라는 것을 알게 되었다.  
